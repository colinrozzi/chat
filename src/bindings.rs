                                    ...
                                    0 => {
                                        let e18 = {
                                            ...
                                            let l14 = *ptr4
                                                ...
                                                .cast::<i32>();
                                            CommandSuccess {
                                                stdout: _rt::string_lift(bytes10),
                                                stderr: _rt::string_lift(bytes13),
                                                exit_code: l14,
                                            }
                                        };
                                        CommandResult::Success(e18)
                                    }
                                    n => {
                                    ...
                                    0 => {
                                        let e16 = {
                                            ...
                                            let l12 = *ptr2
                                                ...
                                                .cast::<i32>();
                                            CommandSuccess {
                                                stdout: _rt::string_lift(bytes8),
                                                stderr: _rt::string_lift(bytes11),
                                                exit_code: l12,
                                            }
                                        };
                                        CommandResult::Success(e16)
                                    }
                                    n => {
                                        debug_assert_eq!(n, 1, "invalid enum discriminant");
                                        let e16 = {
        ...
        pub mod http_framework {
            ...
            pub fn disable_websocket(
                ...
                unsafe {
                    ...
                    unsafe {
                        wit_import2(_rt::as_i64(server_id), ptr0.cast_mut(), len0, ptr1)
                    };
                    let l3 = i32::from(*ptr1.add(0).cast::<u8>());
                    let result7 = match l3 {
                        0 => {
        ...
        pub mod theater {
            ...
            pub mod http_handlers {
                ...
                macro_rules! __export_ntwk_theater_http_handlers_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "ntwk:theater/http-handlers#handle-request")] unsafe extern "C"
                        ...
                        > (arg0) } } #[unsafe (export_name =
                        "ntwk:theater/http-handlers#handle-middleware")] unsafe extern
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:ntwk:theater:single-chat:encoded world"
)]
#[doc(hidden)]
...
\x05chain\x03\0\x12\x03\0\x12ntwk:theater/types\x05\0\x02\x03\0\0\x04json\x02\x03\
\0\0\x05chain\x02\x03\0\0\x08actor-id\x01B\x0a\x02\x03\x02\x01\x01\x04\0\x04json\
\x03\0\0\x02\x03\x02\x01\x02\x04\0\x05chain\x03\0\x02\x02\x03\x02\x01\x03\x04\0\x08\
actor-id\x03\0\x04\x01@\x01\x03msgs\x01\0\x04\0\x03log\x01\x06\x01@\0\0\x03\x04\0\
\x09get-chain\x01\x07\x03\0\x14ntwk:theater/runtime\x05\x04\x01B(\x01r\x01\x04ha\
shs\x04\0\x0bcontent-ref\x03\0\0\x01j\x01s\x01s\x01@\0\0\x02\x04\0\x03new\x01\x03\
